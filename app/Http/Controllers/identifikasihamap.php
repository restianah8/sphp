...
class identifikasihamap extends Controller
{
    public function index()
    {
        $gejalahama = Gejalahama::all();
        return view('identifikasihamap/index', compact('gejalahama'));
    }
    public function result(Request $request)
    {
        ...
        foreach ($request->kode as $value) {
            ...
            $getps = DB::table('pengetahuanhama')
                ->select('id_penyakit', 'id_gejalahama', 'bobot')
                ->where('id_gejalahama', $value)
                ->get();
        ...
        foreach ($request->kode as $gjl) {
            $htngp = pengetahuanhama::where('id_gejalahama', $gjl)->get();
        ...
        foreach ($id_penyakit as $index => $id) {
            $identifikasi->gejalahama()->insert([
        ...
        return view('identifikasihamap/result', [
            "penyakit" => $namapenyakit,
