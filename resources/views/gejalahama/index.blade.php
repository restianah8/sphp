...
@section('content')
    ...
    <div class="col-sm-12">
        <div class="page-header float-right mt-2">
            <a href="gejalahama/tambah" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
        </div>
    </div>
                                            ...
                                            <td>
                                                @if ($item->gambar)
                                                    <img style="max-width : 50px; max-height:50px"
                                                        src="{{ url('gambarhama') . '/' . $item->gambar }}" />
                                                @endif
                                            </td>

                                            <td>
                                                <a href="gejalahama/edit/{{ $item->id }}"
                                                    class=" mb-2 fa fa-edit bg-warning p-2 text-white rounded"></a>
                                                <a href="gejalahama/hapus/{{ $item->id }}"
                                                    onclick="return confirm('Yakin Ingin Menghapus Data')"
                                                    class=" mb-2 fa fa-trash bg-danger p-2 text-white rounded"></a>
                                                <a href="{{ route('gejalahama.show', $item->id) }}"
