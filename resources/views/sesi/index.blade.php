        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="">
                        <img class="align-content" src="{{ asset('publik/assets/img/logo1.png') }}" alt=""
                ...
                <div class="login-form">
                    <form action="/sesi/login" method="POST">
                        ...
                        <button name="submit" type="submit"
                            class="btn btn-success btn-flat m-b-30 m-t-30">login</button><br><br>
                        <h6 href="#"></h6><br><br>
                        <center>
                            <a>Belum Punya Akun?</a> <a class="text-success" href="/register">Buat Akun</a>
                        </center>
